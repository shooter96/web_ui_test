...
class TestMqttDevice:
    ...
    def test_add_mqtt_product(self):
        '''
        新增设备类和设备模型
        :return:
        '''
        ...
        product_page.add_direct_product(dd.mqtt_product_data["ProductName"], dd.mqtt_product_data["pk"])
        time.sleep(1)
    ...
    def test_add_direct_mqtt_device(self):
        # 点击设备类的设备管理进行设备新增

        device_data = dd.mqtt_direct_device_data
    ...
    def test_device_online(self):
        try:
            ...
            time.sleep(5)
            # 查看设备状态
            assert self.device_page.get_device_detail_status("MQTT") == "在线"
    ...
    def test_delete_data(self):
        ...
        select_input.send_keys(dd.mqtt_product_data["pk"])
