...
class TestMqttDevice:
    ...
    def test_add_coap_product(self):
        '''
        新增设备类和设备模型
        :return:
        '''
        ...
        coap_product_data = dd.coap_product_data
        product_page.add_direct_product(coap_product_data["ProductName"], coap_product_data["pk"],
                                        coap_product_data["communication_type"])
        time.sleep(1)
    ...
    def test_add_direct_coap_device(self):
        ...
        device_data = dd.coap_direct_device_data
    ...
    def test_device_online(self):
        try:
            ...
            time.sleep(5)
            # 查看设备状态
            assert self.device_page.get_device_detail_status("CoAP") == "激活"
    ...
    def test_delete_data(self):
        ...
        select_input.send_keys(dd.coap_product_data["pk"])
